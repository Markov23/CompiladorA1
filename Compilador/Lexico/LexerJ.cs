...
namespace Compilador.Lexico
{
    class LexerJ
    {
        ...
        public void llenarListaNoTerminales()
        {
            ...
            listaNoTerminales.Add("<asignacion-valor>");
            ...
            listaNoTerminales.Add("<asignar-arreglo>");
        ...
        public void llenarListaTerminales()
        {
            ...
            terminalPalabrasReservadas.Add("void");
            terminalPalabrasReservadas.Add("return");
            terminalPalabrasReservadas.Add("null");
            terminalPalabrasReservadas.Add("true");
            terminalPalabrasReservadas.Add("false");
            terminalPalabrasReservadas.Add("System");
            terminalPalabrasReservadas.Add("out");
            terminalPalabrasReservadas.Add("print");
            terminalPalabrasReservadas.Add("println");
            terminalPalabrasReservadas.Add("break");
            terminalPalabrasReservadas.Add("main");
            terminalPalabrasReservadas.Add("static");
            terminalPalabrasReservadas.Add("public");
            terminalPalabrasReservadas.Add("private");
            terminalPalabrasReservadas.Add("class");
            terminalPalabrasReservadas.Add("Scanner");
            terminalPalabrasReservadas.Add("new");
            terminalPalabrasReservadas.Add("in");
            terminalPalabrasReservadas.Add("import");
            #endregion
            ...
            terminalControladoresFlujo.Add("for");
            terminalControladoresFlujo.Add("switch");
            terminalControladoresFlujo.Add("case");
            #endregion
            ...
            terminalOperadorLogico.Add("&&");
            terminalOperadorLogico.Add("||");
            terminalOperadorLogico.Add("!");
            #endregion

            #region Operadores matematicos
            terminalOperadorMatematico.Add("+=");
            terminalOperadorMatematico.Add("-=");
            terminalOperadorMatematico.Add("*=");
            terminalOperadorMatematico.Add("/=");
            terminalOperadorMatematico.Add("%=");
            ...
            terminalEntrada.Add("nextInt");
            terminalEntrada.Add("nextFloat");
            terminalEntrada.Add("nextDouble");
            terminalEntrada.Add("nextBoolean");
            terminalEntrada.Add("nextChar");
            terminalEntrada.Add("next");
            #endregion
